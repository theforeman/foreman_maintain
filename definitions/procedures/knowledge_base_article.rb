  ...
  def kcs_documents
    {
      ...
      'migrate_self_registered_satellite_63' => 'https://access.redhat.com/documentation/en-us/red_hat_satellite/6.3/html/upgrading_and_updating_red_hat_satellite/upgrading_red_hat_satellite#migrating_a_self_registered_satellite'
    }
  end
end
