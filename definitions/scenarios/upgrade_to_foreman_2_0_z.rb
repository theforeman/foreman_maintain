module Scenarios::Foreman_2_0_z
  ...
  class PreUpgradeCheck < Abstract
    upgrade_metadata do
      description 'Checks before upgrading to Foreman 2.0.z'
  ...
  class PreMigrations < Abstract
    upgrade_metadata do
      description 'Procedures before migrating to Foreman 2.0.z'
      tags :pre_migrations
    end
  ...
  class Migrations < Abstract
    upgrade_metadata do
      description 'Migration scripts to Foreman 2.0.z'
      tags :migrations
    end
  ...
  class PostMigrations < Abstract
    upgrade_metadata do
      description 'Procedures after migrating to Foreman 2.0.z'
  ...
  class PostUpgradeChecks < Abstract
    upgrade_metadata do
      description 'Checks after upgrading to Foreman 2.0.z'
