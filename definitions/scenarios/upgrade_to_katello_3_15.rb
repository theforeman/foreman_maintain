module Scenarios::Katello_3_15
        ...
        confine do
          feature(:instance).upstream? && feature(:foreman_server) && \
            feature(:katello) && (feature(:katello).current_version.major_minor == '3.14' || \
              ForemanMaintain.upgrade_in_progress == '3.15')
        end
        instance_eval(&block)
      end
    end
  ...
  class PreUpgradeCheck < Abstract
    upgrade_metadata do
      description 'Checks before upgrading to Katello 3.15'
  ...
  class PreMigrations < Abstract
    upgrade_metadata do
      description 'Procedures before migrating to Katello 3.15'
      tags :pre_migrations
    end
  ...
  class Migrations < Abstract
    upgrade_metadata do
      description 'Migration scripts to Katello 3.15'
      tags :migrations
    end
  ...
  class PostMigrations < Abstract
    upgrade_metadata do
      description 'Procedures after migrating to Katello 3.15'
  ...
  class PostUpgradeChecks < Abstract
    upgrade_metadata do
      description 'Checks after upgrading to Katello 3.15'
