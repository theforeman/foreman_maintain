module Scenarios::Foreman_1_24_z
        ...
        confine do
          feature(:instance).upstream? && feature(:foreman_server) && \
            (feature(:foreman_server).current_version.major_minor == '1.24' || \
                ForemanMaintain.upgrade_in_progress == '1.24.z') && !feature(:katello)
        end
        instance_eval(&block)
      end
    end
  ...
  class PreUpgradeCheck < Abstract
    upgrade_metadata do
      description 'Checks before upgrading to Foreman 1.24.z'
  ...
  class PreMigrations < Abstract
    upgrade_metadata do
      description 'Procedures before migrating to Foreman 1.24.z'
      tags :pre_migrations
    end
  ...
  class Migrations < Abstract
    upgrade_metadata do
      description 'Migration scripts to Foreman 1.24.z'
      tags :migrations
    end
