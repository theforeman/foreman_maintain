...
describe Features::Tar do
  ...
  context '#validate_volume_size' do
    it 'raises Validation error with incorrect --tape-length formats' do
      ...
      _ { subject.validate_volume_size('blah') }.must_raise error
      _ { subject.validate_volume_size('') }.must_raise error
      _ { subject.validate_volume_size(nil) }.must_raise error
      _ { subject.validate_volume_size('  ') }.must_raise error
      _ { subject.validate_volume_size('20394023x') }.must_raise error
      _ { subject.validate_volume_size('20Z') }.must_raise error
      _ { subject.validate_volume_size('20GB') }.must_raise error
      _ { subject.validate_volume_size('20xG') }.must_raise error
      _ { subject.validate_volume_size('20Gx') }.must_raise error
      _ { subject.validate_volume_size('B') }.must_raise error
      _ { subject.validate_volume_size('W') }.must_raise error
      _ { subject.validate_volume_size('-10B') }.must_raise error
    end
